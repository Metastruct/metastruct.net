  ...
  <div id="addons">
    <section class="section">
      <div class="container">
        ...
        <MessageBox v-else-if="!loading && !servers.length" type="is-info" has-icon>
              ...
              <div class="facts">
                ...
                >
                  ...
                  <div v-else class="badge placeholder">
                    <MdiIcon icon="package-variant" size="is-small" />
                  </div>
                ...
                <div class="card-content">
                  <div class="media">
                    <div class="media-left">
                      <figure class="image is-48x48">
                        ...
                        <div
                          ...
                          title="Private"
                        >
                          <MdiIcon icon="lock" size="is-small" />
                        </div>
                      </figure>
                    </div>
                    <div class="media-content">
                      ...
                      <div class="tags">
                        <span class="tag is-small" :class="sourceClass(addon)">{{
                          sourceLabel(addon)
                        }}</span>
                        <span v-if="branchOf(addon)" class="tag is-small">{{
                          branchOf(addon)
                        }}</span>
                        <span v-if="addon.version" class="tag is-small">{{ addon.version }}</span>
                      </div>
                    </div>
                  </div>
...
export default {
  setup() {
    useHead({ title: "Add-ons - Meta Construct" });
    return useUser();
  },
  data() {
  ...
  mounted() {
    if (this.userLoaded) this.load();
  },
  methods: {
    async load() {
      try {
        const data = await this.$mc("/addons");
